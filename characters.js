(function () {
    window.HANNAM_BALLS_CHARACTERS = [
        ...
        },
        {
            ...
            passive: {
                name: "카페인 과다",
                description: "지태혁 주변에 카페인이 하나씩 설치됩니다. 지태혁은 카페인 방향으로 약간 보정되며, 4.5초 동안 카페인을 먹지 못하면 자동으로 1회 섭취합니다. 섭취 시 최대 체력이 50 감소하는 대신 초당 회복 10과 이동속도 10을 영구적으로 얻습니다. 최대 체력은 150까지 감소하고 초당 회복은 최대 70까지 중첩됩니다. 카페인을 7회 마실 때마다 3점 슛 횟수가 1회 증가하고 준비시간이 30% 감소하며, 3점 슛은 한 스킬당 최대 4회까지 발사됩니다. 스킬은 카페인 소모가 아니라 10초마다 발동됩니다.",
                effects: {
        ...
        },
        {
            ...
            avatarText: "성빈",
            traits: ["악마의 왼발", "회상 공간", "교대 연타"],
            passive: {
                name: "악마의 왼발",
                description: "적과 닿을 때마다 공격력이 -15에서 +15 사이로 무작위 보정됩니다. 피해는 공격력과 보정값을 합산해 계산하며 최소 5, 최대 35입니다.",
                effects: {
                    bonusMin: -15,
                    bonusMax: 15,
                    minDamage: 5,
            ...
            skill: {
                name: "누군가를 회상",
                cooldown: 11,
                description: "가장 가까운 적을 자신의 앞으로 끌어오고 다른 적들을 300의 속도로 밀칩니다. 한 변이 200인 회색 정사각형 공간을 만들고, 그 안에서 누군가와 함께 0.5초마다 번갈아 돌진해 충돌 피해와 700 넉백을 줍니다. 공간의 벽은 적에게 100 피해를 받거나 5초가 지나면 붕괴합니다.",
                effects: {
                    squareSize: 300,
                    wallHp: 100,
                    duration: 5,
                    outerKnockbackSpeed: 300,
                    rushSpeed: 2000,
                    hitInterval: 0.2,
                    hitDamage: 20,
                    hitKnockbackSpeed: 700,
                    someoneImageSrc: "images/박성빈/누군가.png",
                    someoneImageFallbackSrcs: [
                        "images/박성빈/누군가.png"
                    ]
                }
            },
            cooldownOnBasicHit: 0,
