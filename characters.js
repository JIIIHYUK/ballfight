(function () {
    window.HANNAM_BALLS_CHARACTERS = [
        ...
        },
        {
            ...
            color: "#b91c1c",
            textColor: "#ffffff",
            avatarSrc: "images/시위 지도자 구민찬/GMC_2.jpeg",
            avatarText: "시위",
            selectable: false,
            adminSelectable: true,
            traits: ["관리자 전용", "깃발", "시위"],
            passive: {
                name: "자유를 위하여",
                description: "1초마다 주변 225 범위에 적이 있으면 깃발을 한 바퀴 돌립니다. 깃발에 맞은 적은 70 피해를 받고 이동 방향이 시위 지도자 구민찬의 반대 방향으로 바뀌며, 타격한 적 1명당 시위 시작 쿨타임이 1초 감소합니다.",
                effects: {
                    interval: 1,
                    detectionRadius: 225,
                    flagLength: 125,
                    flagSpinDuration: 0.24,
                    flagImageSrc: "images/시위 지도자 구민찬/flag-cloth-extracted.png",
                    damage: 70,
                    cooldownReductionPerHit: 1,
                    knockAwaySpeed: 230
                }
            },
            skill: {
                name: "시위 시작",
                cooldown: 25,
                description: "15초 동안 중앙 150 폭을 제외한 위아래를 붉은 장판으로 덮습니다. 아군은 즉시 스킬을 사용하고 시위 동안 스킬 쿨타임이 75% 감소된 상태로 운용됩니다. 장판 위 적은 쿨타임 감소가 40% 느려지고 이동속도가 10으로 고정되며, 한 적은 시위 대상으로 지정되어 스킬과 패시브가 금제되고 1.5배 피해를 받습니다.",
                effects: {
                    duration: 15,
                    centerSafeHeight: 150,
                    allyCooldownMultiplier: 0.25,
