    ...
    window.HANNAM_BALLS_CHARACTERS = [
        {
            ...
            skill: {
                name: "풍차 돌리기",
                cooldown: 10,
                description: "5초 동안 몸에 붙어 전방 180도 안에서 회전하는 살색 무언가를 휘두릅니다. 막대가 닿을 수 있는 범위 안의 적을 자동으로 향해 회전하며 타격하고, 적에게 충돌하면 피해를 주고 벽으로 날려보내어 피해를 줍니다.",
                effects: {
                    damage: 10,
                    wallDamage: 25,
                    duration: 5,
        ...
        },
        {
            ...
            color: "#0284c7",
            textColor: "#ffffff",
            avatarSrc: "images/권기상 선생님.png",
            avatarText: "기상",
            traits: ["당구채", "스파이럴", "강한 넉백"],
            skill: {
                name: "당구채 스파이럴",
                cooldown: 15,
                description: "게임 시작 후 첫 사용은 5초 뒤 가능하며, 이후 15초마다 거대한 당구채가 사방에서 시계방향으로 중앙을 꿰뚫습니다. 30도 간격으로 총 20개의 당구채가 0.2초마다 나오고, 4개째가 나올 때 첫 당구채가 사라집니다. 당구채가 나오기 0.2초 전 대표색 범위가 표시되며, 시작 지점에서 도착 지점으로 밀고 들어가는 당구채에 피격되면 200 피해와 10000 속도의 넉백을 받고 넉백 중 벽에 부딪히면 100 추가 피해를 받습니다.",
                effects: {
                    initialCooldown: 5,
                    cueCount: 30,
                    angleStep: 30,
        ...
        },
        {
            ...
            passive: {
                name: "배그 마스터",
                description: "모든 피해에 20% 확률로 2배 치명타가 발동합니다. 스킬을 사용할 때마다 수류탄, AR, 12 gauge, SR 순서로 모드가 전환됩니다. 체력이 100 감소할 때마다 1초 동안 무적 및 충돌 무시 상태가 되고 적들과 먼 위치로 이동합니다. 전투당 한 번, 처음 사망 시 400의 임시 체력으로 자가제세동을 시작하며, 성공하면 400의 체력으로 부활합니다.",
                effects: {
                    criticalChance: 0.2,
                    criticalMultiplier: 2,
                    modes: ["수류탄", "AR", "12 gauge", "SR"],
                    damageEscapeThreshold: 100,
        ...
        },
        {
            ...
            skill: {
                name: "공격? 힐?",
                cooldown: 1,
                description: "1초마다 가장 먼 적에게 10의 힐을 주고, 가장 가까운 적에게 20의 피해를 줍니다.",
                effects: {
                    heal: 10,
                    damage: 20,
                    lineDuration: 0.38
        ...
        },
        {
            ...
            passive: {
                name: "연속 질주",
                description: "6초마다 상대를 향해 7번 질주하고 회전베기를 사용합니다. 질주 중에는 충돌 판정을 무시하지만 무적이 아닌 50% 피해감소 상태가 됩니다. 질주 중 적과 부딪히면 베기를 사용해 액티브 쿨타임을 0.5초 줄이고, 회전베기는 액티브 쿨타임을 1초 줄입니다. 같은 상대에게 다시 회전베기를 사용해야 하는 경우 그 회전베기의 모든 피해는 75% 감소합니다.",
                effects: {
                    interval: 6,
                    rushCount: 7,
                    blossomSize: 28,
                    ...
                    rushOpacity: 0.5,
                    slashDamage: 20,
                    slashCooldownReduction: 0.3,
                    spinDamage: 40,
                    rushDamageTakenMultiplier: 0.5,
                    spinCooldownReduction: 0.7,
                    spinDiameter: 120,
