(function () {
    window.HANNAM_BALLS_CHARACTERS = [
        ...
        },
        {
            ...
            passive: {
                name: "가속 잔상",
                description: "2초마다 가속게이지를 쌓아 영구적으로 이동 속도가 10% 증가합니다. 이동거리 200마다 대표색 잔상을 소환하며, 잔상과 부딪힌 적은 1초 동안 경직됩니다. 이후 유예준은 현재 속도의 2배로 경직된 적에게 다가가 30의 피해를 주며, 이 과정에서 해당 적의 공격을 무시합니다. 잔상은 최대 6개까지 유지됩니다.",
                effects: {
        ...
        },
        {
            ...
            passive: {
                name: "드리블",
                description: "1초마다 10% 확률로 5초 동안 드리블 상태에 진입합니다. 드리블 중에는 이동속도가 50% 증가하고 흐릿해지며 무적이 되고 잔상을 남깁니다. 적과 닿으면 앵클브레이크를 일으켜 3초 동안 이동속도를 30% 감소시킵니다.",
                effects: {
                    checkInterval: 1,
                    chance: 0.1,
                    duration: 5,
            ...
            skill: {
                name: "차징 슛",
                cooldown: 12,
                description: "5회 피해가 들어오는 공격을 방어하는 보호막을 생성하고 차징 상태에 진입합니다. 차징 중에는 축구공의 궤적이 흐릿한 빨간 직사각형으로 표시되며 방향은 천천히 전환되고 쿨타임이 감소하지 않습니다. 보호막 5회가 모두 깨지면 공을 강하게 차 공에 맞은 적들을 공의 도착지점까지 날려버리고, 차징시간(초) * (30 * 앵클브레이크 횟수)의 피해를 줍니다.",
                effects: {
                    shieldHits: 5,
                    chargeTurnLerp: 0.055,
                    trajectoryWidthMultiplier: 0.78,
                    kickProjectileSpeed: 2600,
                    ballImageSrc: "images/이태환축구공.png",
                    ballImageFallbackSrcs: [
                        "images/이태환축구공.png"
                    ],
                    hitWidthMultiplier: 1.1,
                    damagePerSecondPerAnkleBreak: 30,
                    targetAfterimageDuration: 0.75
                }
            },
            cooldownOnBasicHit: 0,
        ...
        },
        {
            ...
            skill: {
                name: "타격 연계",
                cooldown: 3,
                description: "적을 공격할수록 숙련도가 1 증가합니다. 공격 후 숙련도 수치만큼 적을 추격해 연타 피해를 주고 이 과정을 반복합니다. 연타 중에는 받는 피해가 50% 감소하고 넉백에 끊기지 않습니다. 숙련도 20 이상에서 연타가 끝나거나 연타를 20번 하면 슬로우 모션 속에서 뒤로 빠진 뒤 간파 돌진으로 200의 피해를 주고 적을 두 배로 강하게 날리며, 발동 후 숙련도는 10으로 재조정됩니다. 기본 회피율은 20%이며 회피 성공 시 잔상을 남기고 뒤로 빠진 뒤 카운터로 숙련도 3을 얻고 연타를 시작합니다.",
                effects: {}
            },
            cooldownOnBasicHit: 0,
            cooldownOnDamageTaken: 0,
