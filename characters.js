    ...
    window.HANNAM_BALLS_CHARACTERS = [
        ...
        },
        {
            ...
            skill: {
                name: "ㄱㅈㅇ 호출",
                cooldown: 15,
                description: "능력을 사용하면 화면 전체가 검게 채워지고 2초 동안 ㄱㅈㅇ 응답 여부가 차례대로 출력됩니다. 80% 확률로 ㄱㅈㅇ 미응답이 나오면 아무 일도 일어나지 않고, 20% 확률로 ㄱㅈㅇ 응답이 나오면 가장 가까운 적을 ㄱㅈㅇ이 벽으로 던져 1000의 피해를 줍니다.",
                effects: {
                    responseChance: 0.2,
                    responseDamage: 1000,
                    revealDuration: 2,
