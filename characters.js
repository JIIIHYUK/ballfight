(function () {
    window.HANNAM_BALLS_CHARACTERS = [
        ...
        },
        {
            ...
            passive: {
                name: "가속 잔상",
                description: "2초마다 가속게이지를 쌓아 영구적으로 이동 속도가 10% 증가합니다. 1초마다 대표색 잔상을 소환하며, 잔상과 부딪힌 적은 1초 동안 경직됩니다. 이후 유예준은 현재 속도의 2배로 경직된 적에게 다가가 20의 피해를 주며, 이 과정에서 해당 적의 공격을 무시합니다. 잔상은 최대 3개까지 유지됩니다.",
                effects: {
