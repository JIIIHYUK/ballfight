(function () {
    window.HANNAM_BALLS_CHARACTERS = [
        ...
        },
        {
            ...
            passive: {
                name: "분노",
                description: "3초가 지날 때마다 점점 빨간색을 띄며 능력의 쿨타임을 0.5초씩 줄입니다. 분노가 10회를 초과하면 초과한 분노 1회당 일반 배구공 피해가 1 증가합니다.",
                effects: {
                    interval: 3,
            ...
            skill: {
                name: "배구공",
                cooldown: 5,
                description: "배구공을 던져 적에게 10의 피해를 줍니다. 배구공을 4회 적중시키면 잠시 준비한 뒤 스파이크 배구공을 날려 100의 피해를 줍니다.",
                effects: {
                    damage: 10,
        ...
        },
        {
            ...
            skill: {
                name: "ㄱㅈㅇ 호출",
                cooldown: 15,
                description: "능력을 사용하면 화면 전체가 검게 채워지고 ㄱㅈㅇ 응답 여부가 출력됩니다. 75% 확률로 ㄱㅈㅇ 미응답이 나오면 아무 일도 일어나지 않고, 25% 확률로 ㄱㅈㅇ 응답이 나오면 가장 가까운 적에게 300의 피해를 확정적으로 주고 벽으로 던집니다. 벽에 부딪히면 500의 피해를 추가로 줍니다.",
                effects: {
                    responseChance: 0.25,
        ...
        },
        {
            ...
            skill: {
                name: "타격 연계",
                cooldown: 3,
                description: "적을 공격할수록 숙련도가 1 증가합니다. 공격 후 숙련도 수치만큼 적을 추격해 연타 피해를 주고 이 과정을 반복합니다. 기본 회피율은 20%이며 회피 성공 시 잔상을 남기고 뒤로 빠진 뒤 카운터로 숙련도 3을 얻고 연타를 시작합니다.",
                effects: {}
            },
            cooldownOnBasicHit: 0,
            cooldownOnDamageTaken: 0,
        ...
        },
        {
            ...
            skill: {
                ...
                cooldown: 0,
                passiveOnly: true,
                description: "모든 넉백을 무시합니다. 자신의 중심 150 범위 안에서 발생한 넉백 효과는 역으로 반사합니다.",
                effects: {}
            },
            cooldownOnBasicHit: 0,
            cooldownOnDamageTaken: 0,
