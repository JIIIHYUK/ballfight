    ...
    window.HANNAM_BALLS_CHARACTERS = [
        ...
        },
        {
            ...
            skill: {
                name: "풍차 돌리기",
                cooldown: 15,
                description: "5초 동안 몸에 붙어 전방 180도 안에서 회전하는 살색 막대를 소환합니다. 적에게 충돌하면 30의 피해를 주고 벽으로 날려보내며 잔상을 남깁니다. 벽에 부딪힌 뒤에는 4000의 힘으로 튀어다니다가 0.1초마다 속도가 500씩 감소하고, 이 추가 속도가 유지되는 동안 벽에 부딪힐 때마다 50의 피해를 입힙니다.",
                effects: {
                    damage: 5,
                    wallDamage: 20,
                    duration: 5,
                    lengthMultiplier: 2.45,
                    widthMultiplier: 0.3,
