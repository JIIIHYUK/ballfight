    ...
    window.HANNAM_BALLS_CHARACTERS = [
        ...
        },
        {
            ...
            skill: {
                name: "타격 연계",
                cooldown: 3,
                description: "적을 공격할수록 숙련도가 1 증가합니다. 공격 후 숙련도 수치만큼 적을 추격해 연타 피해를 주고 이 과정을 반복합니다. 연타 중에는 받는 피해가 50% 감소합니다. 숙련도 20 이상에서 연타를 끝내면 슬로우 모션 속에서 뒤로 빠진 뒤 간파 돌진으로 150의 피해를 주고 적을 강하게 날리며, 발동 후 숙련도는 10으로 재조정됩니다. 기본 회피율은 20%이며 회피 성공 시 잔상을 남기고 뒤로 빠진 뒤 카운터로 숙련도 3을 얻고 연타를 시작합니다.",
                effects: {}
            },
            cooldownOnBasicHit: 0,
            cooldownOnDamageTaken: 0,
