(function () {
    window.HANNAM_BALLS_CHARACTERS = [
        ...
        },
        {
            ...
            passive: {
                name: "선생님들",
                description: "게임 시작 5초 후 즉시 당구채 스파이럴을 사용합니다.",
                effects: {
                    autoCastDelay: 5
                }
            },
        ...
        },
        {
            ...
            passive: {
                name: "선생님들",
                description: "게임 시작 5초 후 즉시 중력 펀치를 사용합니다.",
                effects: {
                    autoCastDelay: 5
                }
            },
        ...
        },
        {
            ...
            passive: {
                name: "배그 마스터",
                description: "모든 피해에 20% 확률로 2배 치명타가 발동합니다. 스킬을 사용할 때마다 수류탄, AR, 12 gauge, SR 순서로 모드가 전환됩니다. 체력이 150 감소할 때마다 연막작전을 사용합니다. 전투당 한 번, 처음 사망 시 400의 임시 체력으로 자가제세동을 시작하며, 성공하면 400의 체력으로 부활합니다.",
                effects: {
                    criticalChance: 0.2,
        ...
        },
        {
            ...
            color: "#d8c3a5",
            textColor: "#1c1b1b",
            avatarSrc: "images/김동규 각성/관리자 김동규.jpeg",
            avatarFallbackSrcs: [
            ...
            passive: {
                ...
                effects: {
                    turretImageSrc: "images/김동규 각성/admin-donggyu-turret-silhouette.png",
                    ...
                    helicopterImageSrc: "images/김동규 각성/공격헬기.png",
            ...
            skill: {
                ...
                effects: {
                    ...
                    planeImageSrc: "images/김동규 각성/admin-donggyu-plane-silhouette.png",
